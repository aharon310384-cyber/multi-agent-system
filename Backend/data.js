...
const OKR = {
  ...
  'pr': [
    { o: 'Доля голоса бренда в целевых медиа растёт', krs: ['KR 1.1: ≥ 8 публикаций в Tier-1/Tier-2 СМИ (Forbes, VC.ru, Habr, отраслевые) за квартал к 30.09.2026', 'KR 1.2: Share of Voice в целевом сегменте ≥ 15% по Mediatoolkit/Brand24 (бенчмарк Meltwater 2025: median SaaS 8–12%) к 30.09.2026', 'KR 1.3: Earned media reach ≥ 500k уникальных читателей за квартал к 30.09.2026'] },
    { o: 'PR-конвейер работает быстро и без срывов', krs: ['KR 2.1: Среднее время от инфоповода до питча журналисту ≤ 24 часов к 30.09.2026', 'KR 2.2: Response rate на холодные питчи ≥ 12% (бенчмарк Muck Rack 2025: median PR pro 5–8%, top 15%+) к 30.09.2026', 'KR 2.3: 100% размещений сопровождаются tracking-метриками (UTM, brand-search uplift) к 30.09.2026'] }
  ],
  'email-marketer': [
    { o: 'Lifecycle-рассылки приносят измеримый retention-лифт', krs: ['KR 1.1: Open rate триггерных цепочек ≥ 42% (HubSpot 2025: 42,35% cross-industry average) к 30.09.2026', 'KR 1.2: Click rate ≥ 6% по transactional + onboarding (бенчмарк Mailchimp 2025: 2,6% средний, top 5%+) к 30.09.2026', 'KR 1.3: Lift в D30 retention от welcome-цепочки ≥ +10pp vs. контрольная группа к 30.09.2026'] },
    { o: 'База контактов растёт и остаётся живой', krs: ['KR 2.1: Прирост подписной базы ≥ 15% QoQ через консент-механики (lead magnets, pop-ups) к 30.09.2026', 'KR 2.2: Unsubscribe rate ≤ 0,5% по любой рассылке (бенчмарк Mailchimp 2025: 0,26% средний) к 30.09.2026', 'KR 2.3: ≥ 5 сегментов в базе с измеримой стратегией lifecycle для каждого к 30.09.2026'] }
  ],
  'motion': [
    { o: 'Видео и motion дают вирусный охват выше рынка', krs: ['KR 1.1: Средний engagement rate Reels/TikTok ≥ 1,2% (бенчмарк Socialinsider 2025: средний 0,52%, top 1%+) к 30.09.2026', 'KR 1.2: ≥ 12 коротких роликов (Reels/Shorts/TikTok) в продакшен за квартал с метриками к 30.09.2026', 'KR 1.3: View-through rate (≥75% длительности) ≥ 25% на 80% выпущенных видео к 30.09.2026'] },
    { o: 'Production-конвейер быстрый и предсказуемый', krs: ['KR 2.1: Среднее время от сценария до финального ролика ≤ 2 рабочих дня для короткого формата к 30.09.2026', 'KR 2.2: ≥ 80% роликов принимаются клиентом с первой итерации после концепт-борда к 30.09.2026', 'KR 2.3: Brand-consistency score (соответствие гайдлайнам) ≥ 95% на 100% выпущенных материалов к 30.09.2026'] }
  ],
  'security-officer': [
    { o: 'Ноль инцидентов безопасности с продуктовыми и операционными последствиями', krs: ['KR 1.1: 0 секретов в репозиториях (gitleaks/trufflehog в CI) — 100% репо покрыты сканированием к 30.09.2026', 'KR 1.2: 0 критичных уязвимостей (CVSS ≥ 9.0) старше 7 дней в проде к 30.09.2026', 'KR 1.3: 0 несанкционированных прод-действий — 100% операций через ревью или approve чека к 30.09.2026'] },
    { o: 'Зрелость процессов безопасности проверяема', krs: ['KR 2.1: 100% PR с изменением Backend/инфры проходят security-чек (OWASP Top 10 + secrets) до мерджа к 30.09.2026', 'KR 2.2: ≥ 2 tabletop-учения по incident response за квартал с фиксацией lesson learned к 30.09.2026', 'KR 2.3: 100% секретов в Vault/Secret Manager — ни одного в .env, отслеживается через secret-scanning к 30.09.2026'] }
  ],
  'intel-scout': [
    { o: 'Дайджест ловит индустриальные изменения раньше, чем команда о них прочитает в новостях', krs: ['KR 1.1: ≥ 90 рабочих дней с непрерывной доставкой дайджеста (≥ 1 в день) за квартал к 30.09.2026', 'KR 1.2: Среднее время от появления инфоповода в источнике до попадания в дайджест ≤ 24 часов к 30.09.2026', 'KR 1.3: ≥ 1 одобренное оркестратором предложение по апгрейду стека из дайджеста в неделю к 30.09.2026'] },
    { o: 'Сигнал-к-шуму высокий, ложных срабатываний почти нет', krs: ['KR 2.1: Reject rate proposals оркестратором ≤ 30% (бенчмарк здорового scout-pipeline: 20-40% reject) к 30.09.2026', 'KR 2.2: 100% proposals имеют ≥ 2 независимых источника + дату + atribution к 30.09.2026', 'KR 2.3: Доля duplicate proposals (по title_hash) ≤ 5% за квартал к 30.09.2026'] }
  ],
  'hr': [
    { o: 'Команда укомплектована и держит сильный bench', krs: ['KR 1.1: Time-to-hire ≤ 30 дней для не-senior позиций, ≤ 45 для senior (бенчмарк LinkedIn Talent 2025: tech median 41 день) к 30.09.2026', 'KR 1.2: Offer acceptance rate ≥ 75% (бенчмарк LinkedIn 2025: median tech 78%) к 30.09.2026', 'KR 1.3: Voluntary attrition ≤ 10% годовая (бенчмарк LinkedIn Workforce 2025: tech avg 13,2%, high-performer ≤ 10%) к 30.09.2026'] },
    { o: 'Онбординг и культура работают, новички продуктивны быстро', krs: ['KR 2.1: 100% новых сотрудников проходят онбординг по чек-листу за первые 14 дней к 30.09.2026', 'KR 2.2: Time-to-productivity ≤ 30 дней для не-senior, ≤ 60 для senior (внутренние replication checks) к 30.09.2026', 'KR 2.3: eNPS ≥ +30 в опросе команды квартально (бенчмарк Culture Amp 2025: tech avg +15, top quartile +30+) к 30.09.2026'] }
  ],
  'finance': [
    { o: 'P&L и кэшфлоу прозрачны и предсказуемы', krs: ['KR 1.1: Месячный P&L закрывается ≤ 5 рабочих дней после конца месяца к 30.09.2026', 'KR 1.2: Cashflow-прогноз на 13 недель — MAPE ≤ 10% (бенчмарк CFO.com 2025: median fintech 8-12%) к 30.09.2026', 'KR 1.3: 0 пропущенных платежей и налоговых дедлайнов за квартал к 30.09.2026'] },
    { o: 'Юнит-экономика и рентабельность сделок под контролем', krs: ['KR 2.1: Маржа по 100% активных проектов считается ежемесячно — убыточные подсвечены к 30.09.2026', 'KR 2.2: Gross margin портфеля ≥ 60% (бенчмарк SaaS Capital 2025: median services 30-40%, top SaaS 75%+) к 30.09.2026', 'KR 2.3: DSO (Days Sales Outstanding) ≤ 30 дней по 80% выставленных счетов к 30.09.2026'] }
  ],
  'lawyer': [
    { o: 'Договоры закрывают сделки быстро и без правовых рисков', krs: ['KR 1.1: Среднее время от запроса до готового типового договора ≤ 2 рабочих дня к 30.09.2026', 'KR 1.2: 100% договоров с контрагентами имеют NDA + защиту ИС + механизм разрешения споров к 30.09.2026', 'KR 1.3: 0 поданных против компании претензий, выигранных оппонентом, за квартал к 30.09.2026'] },
    { o: 'Compliance — на уровне отраслевых требований', krs: ['KR 2.1: 100% обработки персональных данных соответствует 152-ФЗ (РФ) и GDPR (для EU-клиентов) — аудит каждый квартал к 30.09.2026', 'KR 2.2: ≥ 1 правовой ревью по каждой новой публичной фиче (оферта, пользовательское соглашение, политика) до релиза к 30.09.2026', 'KR 2.3: Time-to-review договора ≤ 1 рабочий день для повторных контрагентов, ≤ 3 — для новых к 30.09.2026'] }
  ]
};
