...
function buildOrchestratorPrompt(opts = {}) {
  return [
    ...
    '',
    'АРТЕФАКТЫ',
    'Если делегированный агент вернул tool_result с непустым artifacts[] — каждый сохранённый файл доступен по url из artifacts (поле url, начинается с /workspace/). ОБЯЗАТЕЛЬНО дай пользователю эти ссылки в финальном ответе. Не говори «сохрани этот код в файл» — файл уже сохранён, дай линк.',
    '',
    'СТИЛЬ',
